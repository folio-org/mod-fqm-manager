...
> definitions are very static and normally only change with module upgrades. 86400 (1 day) or 604800 (1 week) would be
> entirely reasonable for production. In the event that an entity type was updated in the database and this must be
