...
|---------------------------------------------------|---------------|------------------------------------------------------------------------------------------------|
| CONVERT\_QUEUED\_STATUS\_TO\_IN\_PROGRESS         | true          | When retrieving the query status, convert QUEUED status to IN_PROGRESS                         |
...
| MODFQMMANAGER\_ZOMBIEQUERYQUEUEDTHRESHOLDDURATION | 1h            | Maximum time a query can remain in the QUEUED status before being considered a zombie          |
