...
| D | Depends on a changed source field and needs verification |
| Y | Working as-is |
...
- NNNX `src/main/resources/entity-types/consortia/simple_consortia_tenant.json5:26` - `simple_consortia_tenant.name` -> source: `FQM.tenant_name`
...
- D `src/main/resources/entity-types/finance/simple_budget.json5:431` - `simple_budget.tags` -> source: `simple_tags.label`
- D `src/main/resources/entity-types/finance/simple_finance_group.json5:114` - `simple_finance_group.acquisition_unit` -> source: `simple_acq_unit.name`
- D `src/main/resources/entity-types/finance/simple_fiscal_year.json5:62` - `simple_fiscal_year.acquisition_unit` -> source: `simple_acq_unit.name`
- `src/main/resources/entity-types/finance/simple_fund.json5:271` - `simple_fund.donor_organizations` -> source: `simple_organization.name`
- D `src/main/resources/entity-types/finance/simple_fund.json5:388` - `simple_fund.tag_list` -> source: `simple_tags.label`
- D `src/main/resources/entity-types/finance/simple_fund.json5:492` - `simple_fund.acquisition_unit` -> source: `simple_acq_unit.name`
- `src/main/resources/entity-types/finance/simple_ledger.json5:85` - `simple_ledger.fiscal_year_one` -> source: `simple_fiscal_year.name`
- D `src/main/resources/entity-types/finance/simple_ledger.json5:158` - `simple_ledger.acquisition_unit` -> source: `simple_acq_unit.name`
- D `src/main/resources/entity-types/finance/simple_transaction.json5:276` - `simple_transaction.tags` -> source: `simple_tags.label`
- `src/main/resources/entity-types/inventory/simple_holdings_record.json5:156` - `simple_holdings_record.call_number_type` -> source: `simple_call_number_type.name`
- D `src/main/resources/entity-types/inventory/simple_holdings_record.json5:414` - `simple_holdings_record.statistical_code_names` -> source: `simple_inventory_statistical_code_full.statistical_code`
- D `src/main/resources/entity-types/inventory/simple_holdings_record.json5:626` - `simple_holdings_record.electronic_access.relationship` -> source: `simple_electronic_access_relationship.name`
- D `src/main/resources/entity-types/inventory/simple_holdings_record.json5:823` - `simple_holdings_record.tags` -> source: `simple_tags.label`
- D `src/main/resources/entity-types/inventory/simple_holdings_record.json5:869` - `simple_holdings_record.notes.holdings_note_type` -> source: `simple_holdings_note_type.name`
- `src/main/resources/entity-types/inventory/simple_holdings_record.json5:929` - `simple_holdings_record.tenant_id` -> source: `FQM.tenant_id`
- `src/main/resources/entity-types/inventory/simple_holdings_record.json5:947` - `simple_holdings_record.tenant_name` -> source: `FQM.tenant_name`
- `src/main/resources/entity-types/inventory/simple_holdings_record.json5:1019` - `simple_holdings_record.additional_call_numbers.call_number_type_id` -> source: `simple_call_number_type.name`
- `src/main/resources/entity-types/inventory/simple_instance.json5:169` - `simple_instance.instance_type_name` -> source: `simple_instance_type.name`
- `src/main/resources/entity-types/inventory/simple_instance.json5:201` - `simple_instance.mode_of_issuance_name` -> source: `simple_mode_of_issuance.name`
- D `src/main/resources/entity-types/inventory/simple_instance.json5:327` - `simple_instance.alternative_titles.title_type` -> source: `simple_alternative_title_type.name`
...
- D `src/main/resources/entity-types/inventory/simple_instance.json5:502` - `simple_instance.contributors.contributor_name_type` -> source: `simple_contributor_name_type.name`
- D `src/main/resources/entity-types/inventory/simple_instance.json5:516` - `simple_instance.contributors.contributor_type` -> source: `simple_contributor_type.name`
- D `src/main/resources/entity-types/inventory/simple_instance.json5:626` - `simple_instance.subjects.subject_source` -> source: `simple_subject_source.name`
- D `src/main/resources/entity-types/inventory/simple_instance.json5:642` - `simple_instance.subjects.subject_type` -> source: `simple_subject_type.name`
...
- D `src/main/resources/entity-types/inventory/simple_instance.json5:916` - `simple_instance.electronic_access.relationship` -> source: `simple_electronic_access_relationship.name`
- D `src/main/resources/entity-types/inventory/simple_instance.json5:1004` - `simple_instance.format_names` -> source: `simple_instance_format.name`
...
- D `src/main/resources/entity-types/inventory/simple_instance.json5:1269` - `simple_instance.statistical_code_names` -> source: `simple_inventory_statistical_code_full.statistical_code`
- D `src/main/resources/entity-types/inventory/simple_instance.json5:1323` - `simple_instance.tags` -> source: `simple_tags.label`
- D `src/main/resources/entity-types/inventory/simple_instance.json5:1377` - `simple_instance.nature_of_content_term` -> source: `simple_nature_of_content_term.name`
- `src/main/resources/entity-types/inventory/simple_instance.json5:1430` - `simple_instance.tenant_id` -> source: `FQM.tenant_id`
- `src/main/resources/entity-types/inventory/simple_instance.json5:1449` - `simple_instance.tenant_name` -> source: `FQM.tenant_name`
...
- D `src/main/resources/entity-types/inventory/simple_item.json5:555` - `simple_item.electronic_access.relationship` -> source: `simple_electronic_access_relationship.name`
- D `src/main/resources/entity-types/inventory/simple_item.json5:666` - `simple_item.statistical_code_names` -> source: `simple_inventory_statistical_code_full.statistical_code`
- D `src/main/resources/entity-types/inventory/simple_item.json5:1044` - `simple_item.tags` -> source: `simple_tags.label`
...
- `src/main/resources/entity-types/inventory/simple_item.json5:1271` - `simple_item.tenant_id` -> source: `FQM.tenant_id`
- `src/main/resources/entity-types/inventory/simple_item.json5:1289` - `simple_item.tenant_name` -> source: `FQM.tenant_name`
...
- D `src/main/resources/entity-types/invoice/simple_invoice.json5:569` - `simple_invoice.acquisition_unit` -> source: `simple_acq_unit.name`
- D `src/main/resources/entity-types/invoice/simple_invoice.json5:673` - `simple_invoice.tag_list` -> source: `simple_tags.label`
- D `src/main/resources/entity-types/invoice/simple_invoice_line.json5:481` - `simple_invoice_line.tag_list` -> source: `simple_tags.label`
- D `src/main/resources/entity-types/invoice/simple_voucher.json5:218` - `simple_voucher.acquisition_units` -> source: `simple_acq_unit.name`
...
- D `src/main/resources/entity-types/orders/simple_purchase_order.json5:384` - `simple_purchase_order.acquisition_unit` -> source: `simple_acq_unit.name`
- D `src/main/resources/entity-types/orders/simple_purchase_order.json5:417` - `simple_purchase_order.tags` -> source: `simple_tags.label`
...
- D `src/main/resources/entity-types/orders/simple_purchase_order_line.json5:1276` - `simple_purchase_order_line.locations.tenant_name` -> source: `simple_consortia_tenant.name`
- D `src/main/resources/entity-types/orders/simple_purchase_order_line.json5:1770` - `simple_purchase_order_line.tags` -> source: `simple_tags.label`
- D `src/main/resources/entity-types/organizations/simple_organization.json5:239` - `simple_organization.type_names` -> source: `simple_organization_type.name`
- D `src/main/resources/entity-types/organizations/simple_organization.json5:1583` - `simple_organization.acq_unit_names` -> source: `simple_acq_unit.name`
- D `src/main/resources/entity-types/organizations/simple_organization.json5:1603` - `simple_organization.tags` -> source: `simple_tags.label`
...
- D `src/main/resources/entity-types/users/simple_user_details.json5:529` - `simple_user_details.tags_tag_list` -> source: `simple_tags.label`
- D `src/main/resources/entity-types/users/simple_user_details.json5:576` - `simple_user_details.departments` -> source: `simple_department.name`
