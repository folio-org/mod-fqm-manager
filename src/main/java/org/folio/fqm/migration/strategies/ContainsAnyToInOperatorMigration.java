...
/**
 * POC Migration strategy to map legacy 'contains_any' operator to the new 'in' operator.
 * 
 ...
 * as the semantic meaning remains the same.
 */
@Log4j2
@RequiredArgsConstructor
public class ContainsAnyToInOperatorMigration implements MigrationStrategy {

  private final ObjectMapper objectMapper = new ObjectMapper();

  @Override
  public String getMaximumApplicableVersion() {
    return "12"; // Assuming this is for version 12 -> 13 transition
  }

  @Override
  public String getLabel() {
    return "V12 -> V13 Contains Any to In operator migration (POC)";
  }
