...
/**
 * Version 13 -> 13.5, handles a change in the effective library name and code fields in the items entity type.
 *
 ...
 *
 * @see https://folio-org.atlassian.net/browse/MODFQMMGR-885 for adding this migration
 */
@Log4j2
@RequiredArgsConstructor
public class V13ItemLocLibraryValueChange implements MigrationStrategy {

  public static final String SOURCE_VERSION = "13";
  public static final String TARGET_VERSION = "13.5";
  ...
  public String getLabel() {
    return "V13 -> V13.5 item effective library name/code value transformation (MODFQMMGR-885)";
  }
