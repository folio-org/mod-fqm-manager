...
public class V5UUIDNotEqualOperatorRemoval extends AbstractRegularMigrationStrategy<Void> {
  ...
  public SingleFieldMigrationResult<MigratableFqlFieldAndCondition> migrateFql(
    ...
    Set<String> fieldsToTarget = UUID_FIELDS.getOrDefault(condition.entityTypeId(), Set.of());
    if (!fieldsToTarget.contains(condition.field())) {
