...
public class PermissionsRegularService implements PermissionsService {
  ...
  private final ModRolesKeyClockClient modRolesKeycloakClient;
  ...
  public Set<String> getUserPermissions(String tenantId) {
    ...
    return cache.get(key, k -> isEureka ? getUserPermissionsFromRolesKeycloak(tenantId, k.userId()) : getUserPermissionsFromModPermissions(tenantId, k.userId()));
  }
