...
FROM corsair_lib_mod_fqm_manager.src_inventory_statistical_code statcode
JOIN corsair_lib_mod_fqm_manager.src_inventory_statistical_code_type stattype ON stattype.id::text = statcode.jsonb ->> 'statisticalCodeTypeId';
