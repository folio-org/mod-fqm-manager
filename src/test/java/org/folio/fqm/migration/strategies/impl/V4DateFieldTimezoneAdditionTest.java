      ...
      Arguments.of(
        ...
        MigratableQueryInformation
          ...
          .fqlQuery(
            ...
            {
              "$and": [
                {"items.updated_date": { "$ne": "2024-05-01T12:34:56.000" }},
                {"items.updated_date": { "$eq": "2024-07-01T04:00:00.000" }},
                {"items.updated_date": { "$leq": "2024-11-01T04:00:00.000" }},
                {"items.updated_date": { "$empty": false }},
                {"items.last_check_in_date_time": { "$eq": "2024-01-01T05:00:00.000" }},
