  ...
  static List<Arguments> jooqConditionsSource() {
    ...
    return Arrays.asList(
        ...
        Arguments.of(
            ...
            DSL.condition("{0} @> {1}::jsonb", field("jsonbArrayField").cast(JSONB.class), DSL.inline("[\"German\"]"))),
        Arguments.of(
            "not equals string",
            """
        ...
        Arguments.of(
            ...
            cast(field("stringUUIDField"), String.class).notEqualIgnoreCase("69939c9a-aa96-440a-a873-3b48f3f4f608")
            ...
            field("rangedUUIDField").isNull()
                .or(cast(field("rangedUUIDField"), UUID.class)
                    ...
                    .and(cast(field("rangedUUIDField"), UUID.class)
                        .ne(cast(inline(UUID.fromString("69939c9a-aa96-440a-a873-3b48f3f4f602")), UUID.class))))),
        Arguments.of(
            "not in list open UUID",
            """
        ...
        Arguments.of(
            ...
            DSL.and(
                DSL.condition("{0} @> {1}::jsonb", field("jsonbArrayField", JSONB.class).cast(JSONB.class),
                    DSL.inline("[\"value1\"]")),
                DSL.condition("{0} @> {1}::jsonb", field("jsonbArrayField", JSONB.class).cast(JSONB.class),
                    DSL.inline("[\"value2\"]")))),
        Arguments.of(
        ...
        Arguments.of(
            ...
            field("thisIsAFilterValueGetter").eq(field("lower(:value)", param("value", "Test value".toLowerCase())))
                .and(field("fieldWithAValueFunction")
                    .equalIgnoreCase(field("upper(:value)", String.class, param("value", "Test value2"))))),
        ...
        Arguments.of(
            ...
            or(
                field("fieldWithAValueFunction")
                    .equalIgnoreCase(field("upper(:value)", String.class, param("value", "value1"))),
        ...
        Arguments.of(
            ...
            field("fieldWithAValueFunction").isNull().or(
                and(
                    field("fieldWithAValueFunction")
                        .notEqualIgnoreCase(field("upper(:value)", String.class, param("value", "value1"))),
                    field("fieldWithAValueFunction").notEqual(field("upper(:value)", String.class, param("value", 2))),
                    field("fieldWithAValueFunction")
                        .notEqual(field("upper(:value)", String.class, param("value", true)))))),
