                ...
                .columns(
                        List.of(
                                ...
                                new EntityTypeColumn().name("field2")
                                        .dataType(new EntityDataType().dataType("booleanType")),
                                new EntityTypeColumn().name("field3")
                                        .dataType(new EntityDataType().dataType("stringType")),
                                new EntityTypeColumn().name("field4").dataType(new DateType().dataType("dateType")),
                                new EntityTypeColumn().name("field5")
                                        .dataType(new EntityDataType().dataType("integerType")),
                                new EntityTypeColumn().name("rangedUUIDField")
                                        .dataType(new EntityDataType().dataType("rangedUUIDType")),
                                new EntityTypeColumn().name("stringUUIDField")
                                        .dataType(new EntityDataType().dataType("stringUUIDType")),
                                new EntityTypeColumn().name("openUUIDField")
                                        .dataType(new EntityDataType().dataType("openUUIDType")),
                                new EntityTypeColumn().name("arrayField")
                                        .dataType(new EntityDataType().dataType("arrayType")),
                                new EntityTypeColumn().name("jsonbArrayField")
        ...
        return Arrays.asList(
                ...
                Arguments.of(
                        ...
                        cast(field("rangedUUIDField"), UUID.class)
                                .eq(cast(inline(UUID.fromString("69939c9a-aa96-440a-a873-3b48f3f4f608")), UUID.class))),
                Arguments.of(
                        "equals ranged UUID",
                ...
                Arguments.of(
                        ...
                        cast(field("stringUUIDField"), String.class)
                                .equalIgnoreCase("69939c9a-aa96-440a-a873-3b48f3f4f608")),
                Arguments.of(
                        "equals arrayType",
                        """
                ...
                Arguments.of(
                        "equals jsonbArrayType",
                        """
                                {"jsonbArrayField": {"$eq": "value1"}}""",
                        DSL.condition("{0} @> {1}::jsonb", field("jsonbArrayField").cast(JSONB.class),
                                DSL.inline("[\"value1\"]"))),
                Arguments.of(
                        "equals arrayType with language example - French",
                        """
                                {"arrayField": {"$eq": "French"}}""",
                        arrayOverlap(cast(field("arrayField"), String[].class), cast(array("French"), String[].class))),
                Arguments.of(
                        "equals arrayType with language example - English",
                        """
                                {"arrayField": {"$eq": "English"}}""",
                        arrayOverlap(cast(field("arrayField"), String[].class),
                                cast(array("English"), String[].class))),
                Arguments.of(
                        "equals jsonbArrayType with language example - German",
                        """
                                {"jsonbArrayField": {"$eq": "German"}}""",
                        DSL.condition("{0} @> {1}::jsonb", field("jsonbArrayField").cast(JSONB.class),
                                DSL.inline("[\"German\"]"))),
                Arguments.of(
                        "not equals string",
                ...
                Arguments.of(
                        ...
                        cast(field("stringUUIDField"), String.class)
                                .notEqualIgnoreCase("69939c9a-aa96-440a-a873-3b48f3f4f608")
                                .or(field("stringUUIDField").isNull())),
                Arguments.of(
                        "not equals numeric",
                        """
                                {"field5": {"$ne": 10}}""",
                ...
                Arguments.of(
                        ...
                        not(arrayOverlap(cast(field("arrayField"), String[].class),
                                cast(array("value1"), String[].class)))
                ...
                Arguments.of(
                        ...
                        not(arrayOverlap(cast(field("arrayField"), String[].class),
                                cast(array("French"), String[].class)))
                                .or(field("arrayField").isNull())),
                Arguments.of(
                ...
                Arguments.of(
                        ...
                        condition("{0} ~* {1}", field("fieldWithAValueFunction"),
                                field("upper(:value)", String.class, param("value", "some_text")))),
                Arguments.of(
                        "starts_with",
                        """
                ...
                Arguments.of(
                        ...
                        arrayOverlap(cast(field("arrayField"), String[].class),
                                cast(array("French", "German", "English"), String[].class))),
                Arguments.of(
                        "in list for jsonbArrayType",
                        """
                                {"jsonbArrayField": {"$in": ["Dutch", "Italian"]}}""",
                        DSL.condition("{0} && {1}::jsonb", field("jsonbArrayField").cast(JSONB.class),
                                DSL.inline("[\"Dutch\", \"Italian\"]"))),
                Arguments.of(
                        "in list open UUID",
                        """
                ...
                Arguments.of(
                        ...
                        field("rangedUUIDField").isNull()
                                .or(cast(field("rangedUUIDField"), UUID.class)
                                        .ne(cast(inline(UUID.fromString("69939c9a-aa96-440a-a873-3b48f3f4f608")),
                                                UUID.class))
                                        .and(cast(field("rangedUUIDField"), UUID.class)
                                                .ne(cast(
                                                        inline(UUID.fromString("69939c9a-aa96-440a-a873-3b48f3f4f602")),
                                                        UUID.class))))),
                Arguments.of(
                        "not in list open UUID",
                        """
                        ...
                        field("openUUIDField").isNull()
                                .or(cast(field("openUUIDField"), UUID.class)
                                        .ne(cast(inline(UUID.fromString("69939c9a-aa96-440a-a873-3b48f3f4f608")),
                                                UUID.class))
                                        .and(trueCondition))),
                Arguments.of(
                ...
                Arguments.of(
                        ...
                        DSL.and(
                                DSL.condition("{0} @> {1}::jsonb",
                                        field("jsonbArrayField", JSONB.class).cast(JSONB.class),
                                        DSL.inline("[\"value1\"]")),
                                DSL.condition("{0} @> {1}::jsonb",
                                        field("jsonbArrayField", JSONB.class).cast(JSONB.class),
                                        DSL.inline("[\"value2\"]")))),
                ...
                Arguments.of(
                        ...
                        cast(field("arrayField"), String[].class)
                                .notContains(cast(array("Some vALUE"), String[].class))),
                Arguments.of(
                ...
                Arguments.of(
                        ...
                        arrayOverlap(cast(field("arrayField"), String[].class),
                                cast(array("Some vALUE"), String[].class))),
                Arguments.of(
                ...
                Arguments.of(
                        ...
                        field("thisIsAFilterValueGetter")
                                .eq(field("lower(:value)", param("value", "Test value".toLowerCase())))
                                .and(field("fieldWithAValueFunction")
                                        .equalIgnoreCase(
                                                field("upper(:value)", String.class, param("value", "Test value2"))))),
                ...
                Arguments.of(
                        ...
                        or(
                                field("fieldWithAValueFunction")
                                        .equalIgnoreCase(
                                                field("upper(:value)", String.class, param("value", "value1"))),
                                field("fieldWithAValueFunction")
                                        .eq(field("upper(:value)", String.class, param("value", 2))),
                                field("fieldWithAValueFunction")
                                        .eq(field("upper(:value)", String.class, param("value", true))))),
                                ...
                                and(
                                        field("fieldWithAValueFunction")
                                                .notEqualIgnoreCase(
                                                        field("upper(:value)", String.class, param("value", "value1"))),
                                        field("fieldWithAValueFunction")
                                                .notEqual(field("upper(:value)", String.class, param("value", 2))),
                                        field("fieldWithAValueFunction")
                                                .notEqual(
                                                        field("upper(:value)", String.class, param("value", true)))))),
                ...
                Arguments.of(
                        ...
                        field("arrayField").isNull().or(cardinality(cast(field("arrayField"), String[].class)).eq(0))
                                .or(ALL_NULLS.formatted("arrayField"))),
                Arguments.of(
                        "not empty array",
                        """
                                {"arrayField": {"$empty": false}}""",
                        field("arrayField").isNotNull()
                                .and(cardinality(cast(field("arrayField"), String[].class)).ne(0))
                                .and(NOT_ALL_NULLS.formatted("arrayField"))),
                Arguments.of(
                        "empty JSONB array",
                        """
                                {"jsonbArrayField": {"$empty": true}}""",
                        field("jsonbArrayField").isNull()
                                .or(field("jsonb_array_length({0})", Integer.class, field("jsonbArrayField")).eq(0))),
                Arguments.of(
                        "not empty JSONB array",
                        """
                                {"jsonbArrayField": {"$empty": false}}""",
                        field("jsonbArrayField").isNotNull()
                                .and(field("jsonb_array_length({0})", Integer.class, field("jsonbArrayField")).ne(0))));
    }
